          ...
          <div className={style.detailInner}>
            ...
            <div className={style.detaileContent}>
              ...
              <div className={style.detaileContentText}>
                ...
                <div className={style.detaileContentTextSub}>
                  <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga non quos vel labore alias, aliquam quidem sed accusamus obcaecati expedita rerum consectetur debitis repellat quod provident, voluptas a omnis tenetur.

                  </p>


                  <p> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta sint fuga officiis dicta nam? Iusto fugit veniam assumenda sint incidunt rerum? Temporibus magni laborum libero similique dolor aut ullam repellat.
                  </p>
                </div>
              </div>
              ...
              <div className={style.detaileContentText}>
                ...
                <div className={style.detaileContentTextSub}>
                  <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Molestias quos tempora illum pariatur quia, voluptas dicta fuga cupiditate.
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam, molestiae perspiciatis. Fugit illo iste mollitia dolorum. Vitae expedita magni explicabo, possimus saepe ratione doloremque. Quis quidem error quos sunt voluptatem!
                  </p>
                </div>
              </div>

              <div className={style.detaileContentNav}>
                <Link className={style.detaileContentNavLinkPrev}>
                  <svg className={style.detaileContentNavLinkPrevSvg} xmlns="http://www.w3.org/2000/svg" width="50" height="13" viewBox="0 0 50 13" fill="inherit">
                    <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M0.656006 1.33081e-07C-0.606846 2.23877e-05 0.274555 1.41676 0.656006 1.83698L10.8721 12.6848C11.2536 13.1051 11.872 13.1051 12.2535 12.6848C12.6349 12.2646 12.6349 11.5833 12.2535 11.1631L3.7048 2.15214H49.0232C49.5627 2.15214 50 1.67038 50 1.0761C50 0.481823 49.5627 6.58092e-05 49.0232 6.58092e-05H3.7048C3.7048 6.58092e-05 0.858303 -3.43187e-06 0.656006 1.33081e-07Z" fill="inherit" />
                  </svg>
                  Previous work
                </Link>
                <Link className={style.detaileContentNavLinkNext}>
                  next work <svg className={style.detaileContentNavLinkNextSvg} xmlns="http://www.w3.org/2000/svg" width="50" height="13" viewBox="0 0 50 13" fill="none">
